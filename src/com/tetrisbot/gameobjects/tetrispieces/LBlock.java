    ...
    public boolean checkRotation() {
        ...
        switch(tempRot) {
            ...
            case 1:
                ...
                break;
            case 2:
                block0 = block0.add(new Vector2D(2, 1));
                block1 = block1.add(new Vector2D(1, 1));
                block2 = block2.add(new Vector2D(0, 1));
                block3 = block3.add(new Vector2D(0, 2));
                break;
            case 3:
                block0 = block0.add(new Vector2D(1, 2));
                block1 = block1.add(new Vector2D(1, 1));
                block2 = block2.add(new Vector2D(1, 0));
                block3 = block3.add(new Vector2D(0, 0));
                break;
        }
